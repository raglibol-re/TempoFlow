...
| P5.1 | Money-flow animation + net-balance meter + receipts view | todo | — |
| P5.2 | Mobile layout, empty/error states, reconnects | todo | — |
| P5.3 | Docs 07/08 + README with GIF | todo | — |
